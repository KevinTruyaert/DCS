...
\subsection*{Bijlage 4.1.1.1: bordschema theorie}
\begin{center}
...
\includepdf[scale = 0.8,pages = 17,pagecommand=\subsection*{Bijlage 4.1.1.2: opgeloste oefeningen}]{Observaties_OpgelosteOef}
\includepdf[scale = 0.8,pages =18-20,pagecommand=]{Observaties_OpgelosteOef}



\includepdf[scale = 0.95,pages = 1,pagecommand=\subsection*{Bijlage 4.1.1.3: oefeningenbundel elektromagnetisme}]{OefeningenBundel}
